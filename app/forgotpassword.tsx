...
export default function ForgotPasswordScreen() {
  ...
  const sendOtpAndVerifyUser = async () => {
    try {
      const response = await axios.post(`${config.apiBaseUrl}/otp/send`, { phone }, { headers: { "Content-Type": "application/json", "Accept": "application/json" }, });
  ...
  const verifyOtp = async () => {
    ...
    try {
      const response = await axios.post(`${config.apiBaseUrl}/otp/verify`, { otp: enteredOtp, phone }, { headers: { "Content-Type": "application/json", "Accept": "application/json" }, });
